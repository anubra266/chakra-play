  ...
  >
    <Box pos="relative" py={3} maxW={{ sm: "xl" }} mx={{ sm: "auto" }}>
      ...
      <Box
        ...
        p={{ sm: 20 }}
      >
        <Box maxW="md" mx="auto" className="max-w-md mx-auto">
          <Flex color="gray.900">
              <chakra.svg
              height="8"
              width="auto"
              viewBox="0 0 998 257"
              fill="none"
              xmlns="http://www.w3.org/2000/svg" my="auto"
            >
              <path
          ...
          >
            <p>
              An advanced online playground for Chakra UI, including support for
              things like:
          </p>
            <List spacing={2}>
              <ListItem>
              ...
              Customizing your{" "}
                <chakra.code fontSize="sm" fontWeight="bold" color="gray.900">
                  extendTheme{" "}
                </chakra.code>
              object
            </ListItem>
            ...
            <p>
              Perfect for learning how the library works, prototyping a new
